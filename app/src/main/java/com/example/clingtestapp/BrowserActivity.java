package com.example.clingtestapp;
...
public class BrowserActivity extends ListActivity {
    ...
    protected class DeviceDisplay {
        ...
        public String getDetailsMessage() {
            ...
            //Log.e("#####"," getDevice Udaversion " + getDevice().getVersion().toString());
            Log.e("#####"," getDevice deviceIdentity " + getDevice().getIdentity().toString());
            //Log.e("#####"," getDevice deviceType " + getDevice().getType().toString());

            Log.e("#####"," getDevice Details " + getDevice().getDetails().getSerialNumber());
            Log.e("#####"," getDevice Details " + getDevice().getDetails().getFriendlyName());
            Log.e("#####"," getDevice Details " + getDevice().getDetails().getBaseURL());
            Log.e("#####"," getDevice Details " + getDevice().getDetails().getManufacturerDetails().getManufacturer());
            Log.e("#####"," getDevice Details " + getDevice().getDetails().getModelDetails().getModelName());
            ...
            if (getDevice().isFullyHydrated()) {
                ...
                sb.append("\n\n");
                sb.append("Name: " + getDevice().getDetails().getFriendlyName());
                sb.append("\n\n");
                sb.append("Model: " + getDevice().getDetails().getModelDetails().getModelName());
                sb.append("\n\n");
                sb.append("Manufacturer: " + getDevice().getDetails().getManufacturerDetails().getManufacturer());
                sb.append("\n\n");
                sb.append("Serial Number: " + getDevice().getDetails().getSerialNumber());
            } else {
